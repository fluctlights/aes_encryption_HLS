...
if {[file isfile AES_Encrypt_axi.autotvin.dat]} {
	file delete -force AES_Encrypt_axi.autotvin.dat
}

if {[file isfile AES_Encrypt_axi.autotvout.dat]} {
	file delete -force AES_Encrypt_axi.autotvout.dat
}
