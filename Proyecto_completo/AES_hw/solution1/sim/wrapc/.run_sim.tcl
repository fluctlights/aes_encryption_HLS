...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "AES_Encrypt_axi.autotvin.dat"
	set constFileTvOut       "AES_Encrypt_axi.autotvout.dat"
	set constFileHdlTvIn     "AES_Encrypt_axi.autohdltvin.dat"
	set constFileHdlTvOut    "AES_Encrypt_axi.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
